    ...
    <div class="bg-gradient-to-b from-white rounded-2xl mt-1">
              ...
              <div class="">
                <div class="grid sm:grid-cols-1">
                  <div class="flex justify-end">
                    <img
                      src="@/assets/img/team/shahid.png"
                      width="180"
                      class="absolute max-w-7xl rounded-full w-48"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div class="w-4/5">
                  ...
                  <p class="text-xl font-bold">Principal investigator</p>
                  <p class="text-md">
                    S Khan lab Mardan khyber pakhtunkhwa, Pakistan Since
                    Feb.2020- currently
                  </p>
                  <p class="text-2xl py-1 font-bold">Education</p>
                  ...
                  <p class="text-xl  font-bold">Research Interests</p>
                  <p class="text-md">
      ...
      <div style="min-height: 120px w-full">
        <div :class="Lab_Assistant" id="collapseWidthExample1">
          <div class="block px-6 rounded-lg shadow-lg h-screen">
            <div class="flex justify-between items-center flex-wrap">
              ...
              <div>
                <img
                  src="@/assets/img/team/tariq.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
              </div>
            </div>
      ...
      <div style="min-height: 120px w-full">
        <div :class="Current_Member" id="collapseWidthExample2">
          <div class="block px-6 rounded-lg shadow-lg">
            <div class="flex justify-between items-center flex-wrap">
              <div class="">
              ...
              <div>
                <img
                  src="@/assets/img/team/waheed.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
            ...
            <div class="flex justify-between items-center flex-wrap">
              ...
              <div>
                <img
                  src="@/assets/img/team/gulzar.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
            ...
            <div class="flex justify-between items-center flex-wrap">
              <div class="">
                ...
                <p class="text-lg font-bold">Research Area</p>
                <p class="text-md">
                  Computational study of phosphorylation related enzyme and
                  there classification
                </p>
              </div>
              <div>
                <img
                  src="@/assets/img/team/farhan.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
            ...
            <div class="flex justify-between items-center flex-wrap">
              ...
              <div>
                <img
                  src="@/assets/img/team/female.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
            ...
            <div class="flex justify-between items-center flex-wrap">
              <div class="">
                ...
                <p class="text-lg font-bold">Research Area</p>
                <p class="text-md">
                  Collection of Hyperaccumulated data & Plant Genomics
                </p>
              </div>
              <div>
                <img
                  src="@/assets/img/team/luqman.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
          ...
          <div class="block p-6 rounded-lg shadow-lg">
            <div class="flex justify-between items-center flex-wrap">
              <div class="">
                ...
                <p class="text-lg font-bold">Research Area</p>
                <p class="text-md">
                  Prevelance of Bacterial Pathogens Causing Nosocomial
                </p>
              </div>
              <div>
                <img
            ...
            <div class="flex justify-between items-center flex-wrap">
              <div class="">
                ...
                <p class="text-lg font-bold">Research Area</p>
                <p class="text-md">
                  Polymers, composites Environment, Fuel Cell, Energy
                </p>
              </div>
              <div>
                <img
                  src="@/assets/img/team/drfaizapng.png"
                  width="180"
                  class="max-w-7xl rounded-full w-48"
                  alt=""
                />
